...
from .live_data_handler import resample_ticks_to_bars
from .historical_service import get_historical_data
...
class LiveRegressionSubscription:
    ...
    symbol: str
    exchange: str
    timeframes: List[str]  # CHANGED: Support multiple timeframes
    timezone: str
...
class LiveRegressionService:
    ...
    def __init__(self):
        self.subscriptions: Dict[Any, LiveRegressionSubscription] = {}  # websocket -> subscription
        self.calculation_contexts: Dict[str, RegressionCalculationContext] = {}  # symbol:interval -> context
        self.redis_subscriptions: Dict[str, Any] = {}  # symbol -> pubsub
        self.calculation_tasks: Dict[str, asyncio.Task] = {}  # symbol:interval -> task
    ...
    async def _load_historical_data(self, context: RegressionCalculationContext):
        ...
        try:
            ...
            start_time = end_time - timedelta(days=30)  # Adjust based on your needs
    ...
    async def _broadcast_results(self, context_key: str, results: dict):
        ...
        # Send to all relevant websockets
        tasks = []
